...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    iget-object v0, p0, Lg2/r;->a:Landroid/graphics/Canvas;
    ...
    .line 4
    .line 5
    invoke-static {v0, p1}, Le1/e;->w(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    .line 3
    invoke-static {v0, p1, p2, p3, p4}, Le1/e;->u(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    .line 4
    invoke-static {v0, p1, p2, p3, p4}, Le1/e;->v(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    .line 2
    invoke-static {v0, p1}, Le1/e;->x(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    .line 1
    invoke-static {v0, p1}, Le1/e;->y(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    .line 4
    .line 5
    invoke-static {v0}, Lj1/a;->q(Landroid/graphics/Canvas;)V
...
.method public final drawArc(FFFFFFZLandroid/graphics/Paint;)V
    ...
    iget-object v1, v0, Lg2/r;->a:Landroid/graphics/Canvas;
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    .line 4
    invoke-static {v0, p1, p2}, La9/d;->l(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    .line 2
    invoke-static {v0, p1, p2}, La9/d;->m(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    .line 5
    invoke-static {v0, p1, p2, p3}, La9/d;->n(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 1
    invoke-static/range {v0 .. v7}, La9/d;->o(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    .line 2
    invoke-static/range {v0 .. v5}, La9/d;->p(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {v0 .. v7}, Landroidx/media3/exoplayer/j0;->k(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 1
    invoke-static {v0, p1, p2, p3}, Landroidx/media3/exoplayer/j0;->i(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    .line 2
    invoke-static {v0, p1, p2, p3}, Landroidx/media3/exoplayer/j0;->j(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 4
    .line 5
    invoke-static {v0, p1}, Ln3/f2;->l(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 3
    invoke-static/range {v1 .. v10}, La9/d;->q(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 4
    .line 5
    invoke-static {v0}, Lj1/a;->k(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    .line 6
    invoke-static {v0, p1, p2, p3, p4}, Landroidx/media3/common/j;->v(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    .line 4
    invoke-static {v0, p1}, Landroidx/media3/common/j;->w(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    .line 2
    invoke-static {v0, p1}, Landroidx/media3/common/j;->x(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
