...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->l:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->l:Ljava/util/ArrayList;
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 7
    .line 8
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->j(Landroid/media/session/PlaybackState;)Ljava/util/List;
    ...
    .line 40
    .line 41
    invoke-static {v4}, Landroid/support/v4/media/session/m0;->l(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    .line 49
    .line 50
    invoke-static {v4}, Landroid/support/v4/media/session/m0;->f(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;
    ...
    .line 54
    invoke-static {v4}, Landroid/support/v4/media/session/m0;->o(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;
    ...
    .line 58
    invoke-static {v4}, Landroid/support/v4/media/session/m0;->m(Landroid/media/session/PlaybackState$CustomAction;)I
    ...
    .line 64
    .line 65
    iput-object v4, v6, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->h:Landroid/media/session/PlaybackState$CustomAction;
    ...
    .line 78
    :goto_2
    invoke-static {v1}, Landroid/support/v4/media/session/n0;->a(Landroid/media/session/PlaybackState;)Landroid/os/Bundle;
    ...
    .line 88
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->r(Landroid/media/session/PlaybackState;)I
    ...
    .line 92
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->q(Landroid/media/session/PlaybackState;)J
    ...
    .line 96
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->i(Landroid/media/session/PlaybackState;)J
    ...
    .line 100
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->p(Landroid/media/session/PlaybackState;)F
    ...
    .line 104
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->g(Landroid/media/session/PlaybackState;)J
    ...
    .line 109
    .line 110
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->k(Landroid/media/session/PlaybackState;)Ljava/lang/CharSequence;
    ...
    .line 114
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->n(Landroid/media/session/PlaybackState;)J
    ...
    .line 118
    invoke-static {v1}, Landroid/support/v4/media/session/m0;->h(Landroid/media/session/PlaybackState;)J
...
.method public final toString()Ljava/lang/String;
    ...
    .line 87
    .line 88
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->l:Ljava/util/ArrayList;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 35
    .line 36
    iget-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->l:Ljava/util/ArrayList;
